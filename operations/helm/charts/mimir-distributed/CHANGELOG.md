...
* [ENHANCEMENT] The new value `serviceMonitor.clusterLabel.enabled` controls whether to add a `cluster` label to ServiceMonitor metrics. #2125
* [ENHANCEMENT] The new value `serviceMonitor.clusterLabel.value` can be used to overwrite the default `cluster` label in ServiceMonitor metrics. #2125
